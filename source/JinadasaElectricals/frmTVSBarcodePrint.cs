...
namespace BarcodeGenarator
{
    public partial class frmTVSBarcodePrint : Form
    {
        ...
        {
            _foundItems = (from c in dc.Items where c.IsDeleted == false && c.ItemCategory.ItemCategoryDescription.ToUpper()=="TVS" select c ).ToList<Item>();
