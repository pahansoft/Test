...
namespace BarcodeGenarator
{
    public partial class frmHeroBarcodePrint : Form
    {
        ...
        {
            _foundItems = (from c in dc.Items where c.IsDeleted == false && c.ItemCategory.ItemCategoryDescription.ToUpper() == "HERO" select c).ToList<Item>();
